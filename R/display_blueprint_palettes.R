...
display_blueprint_all <- function(){
  ...
  palette_list <-
    rev(
      list(
        tidyr::nest(reformat_palette(bptheme::primary_brand_colours), data = everything()),
        tidyr::nest(reformat_palette(bptheme::blueprint_blues), data = everything()),
        tidyr::nest(reformat_palette(bptheme::blueprint_greys), data = everything()),
        tidyr::nest(reformat_palette(bptheme::blueprint_corals), data = everything()),
        tidyr::nest(reformat_palette(bptheme::blueprint_greens), data = everything()),
        tidyr::nest(reformat_palette(bptheme::blueprint_discrete_palette_multi), data = everything()),
        tidyr::nest(reformat_palette(bptheme::blueprint_discrete_palette), data = everything()),
        tidyr::nest(reformat_palette(bptheme::blueprint_discrete_palette_bold), data = everything()),
        tidyr::nest(reformat_palette(bptheme::blueprint_discrete_palette_rbg), data = everything())
      )
    )
